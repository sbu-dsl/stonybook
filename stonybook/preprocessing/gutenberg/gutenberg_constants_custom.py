...
TEXT_START_MARKERS = frozenset((u(_) for _ in (
    ...
    "The Foundations EIN or federal tax identification number is 64-6221541.",
    ...
    "Additional proofing by",
    "software or any other related product without express permission.]",
    "Prepared by David Reed haradda@aol.com or davidr@inconnect.com",
    "This Etext was prepared for Project Gutenberg",
    "hscrr@vgernet.net",
    "Transcribed for Project Gutenberg",
    "Project Gutenberg",
...
FULL_LINE_START_MARKERS = frozenset((u(_) for _ in (
    "Bowler",
    "Team.",
    "Jim Tinsley.",
    "Team"
